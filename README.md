...
- Building hands-on projects using **AWS (EC2, S3, IAM, VPC)**
- Learning **Docker** and container-based deployments
- Exploring **CI/CD pipelines** with GitHub Actions
- Strengthening **Linux fundamentals and cloud security basics**
...
- Grow into a **Cloud / DevOps Engineer**
- Design and deploy **scalable cloud-based applications**
- Work on real-world systems with production-level exposure
- Continuously learn and adapt to modern cloud technologies
...
<p align="center">
  <a href="mailto:bhongmayur5@gmail.com">
